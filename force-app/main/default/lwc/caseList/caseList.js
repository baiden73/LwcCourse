...
export default class CaseList extends LightningElement {
    ...
    cases;                              // property to hold the case records returned from getRelatedListRecords
    results;                            // prpety to hold response object from the wire service

    // wire up the getRelatedListRecords methods and handle the response
